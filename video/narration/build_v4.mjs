...
// 用法: node build_v4.mjs <zh|en>
// 「先配音、后定轴」：实测音长 → 场景窗口 = 0.3s lead-in + 旁白 + 1.2s 尾部留白
...
const segmentsDir = path.join(__dirname, `segments_v4_${locale}`);
...
const outWav = path.join(segmentsDir, `narration_v4_${locale}.wav`);
